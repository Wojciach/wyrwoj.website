        ...
        <section id="contactForm">
            ...
            <div className="fake-margin" >
                ...
                <form onSubmit={handleSubmit}>
                    <input id="rName" name="rName" type="text" placeholder="Name & Surname..." required maxLength="50"/>
                    <input id="rPhone" name="rPhone" type="tel" placeholder="Telephone..." required maxLength="20" pattern="^\+?(?:[0-9] ?){6,14}[0-9]$"/>
                    <input id="rEmail" name="rEmail" type="email" placeholder="Email..." required maxLength="100"/>
                    <textarea id="rMsg" name="rMsg" rows="130" placeholder="Tell me more..." required maxLength="1000"></textarea>
